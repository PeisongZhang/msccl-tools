...
def alltoall_p2p_pairwise(num_ranks, instances, gpus_per_node, protocol):
    topology = fully_connected(num_ranks)
    collective = AllToAll(num_ranks, 1, inplace=False)

    with MSCCLProgram("alltoall_p2p_pairwise", topology, collective, instances=instances, \
...
alltoall_p2p_pairwise(args.num_gpus, args.instances, args.gpus_per_node, args.protocol)
